...
$(document).ready(function () {
    $(window).scroll(function () {
        ...
        if (scroll > (dark_pos - 150) && menu_pos1 < (dark_pos + dark_height + 150)) {
            ...
            $('svg[id="krooneman__logo"]').addClass('nav__white');
            $('.top').removeClass('nav__black');
            $('svg[id="krooneman__logo"]').removeClass('nav__black');
            ...
            $('svg[id="krooneman__logo"]').removeClass('nav__white');
            $('.top').addClass('nav__black');
            $('svg[id="krooneman__logo"]').addClass('nav__black');
        }
